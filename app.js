...
function sumAndMultiply(a,b,c){
  var resultSum = sum((sum(a,b)[0]),c)[0];
  // console.log(resultSum);
  var messageSum = ''.concat(a, ' and ', b, ' and ', c, ' sum to ', resultSum, '.');
  //console.log(messageSum);
  var resultProduct = multiply((multiply(a,b)[0]),c)[0];
  //console.log(resultProduct);
  var messageProduct = ''.concat('The product of ', a, ' and ', b, ' and ', c, ' is ', resultProduct, '.');
  //console.log(messageProduct);
  return [resultSum, messageSum, messageProduct, resultProduct];
}
...
function sumArray(testArray){
  result = sum(sum(testArray[0],testArray[1])[0], testArray[2]);
  // console.log(result);
  var message = ''.concat(testArray[0], ',',testArray[1], ',',testArray[2], ' was passed in as an array of numbers', ', and ', result[0], ' is their sum.');
  // console.log(message);
  return[result, message];
}
//sumArray(testArray);
...
testArray = [2,3,4];
function multiplyArray(testArray) {
  result = multiply(multiply(testArray[0],testArray[1])[0], testArray[2])[0];
  //console.log(result);
  var message = ''.concat('The numbers ', testArray[0], ',',testArray[1], ',',testArray[2],' have a product of ', result, '.');
  //console.log(message);
  return[result, message];
}
